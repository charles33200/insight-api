...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\Saffroncoin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Saffroncoin/';
  if (isLinux) dataDir = process.env.HOME + '/.saffroncoin/';
}
